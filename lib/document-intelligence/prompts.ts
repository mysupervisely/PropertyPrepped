...
Group fields under sections such as "Key Details", "Financial Information", and "Rules & Restrictions".`,
  ...
  Other: `This document doesn't map to one of PropPrepped's specific document types. Read it carefully and extract whatever structured, factual information a property owner would want to keep — key parties, key dates, financial amounts, and anything unusual worth reviewing. Group fields under sections that fit the document's actual content (e.g. "Key Details", "Financial Information", "Important Dates"). If you can tell it actually IS one of PropPrepped's other supported types, say so in the classification.`,
}
