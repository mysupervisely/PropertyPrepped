...
//   own subscription row, verifying they own a property, etc. Every M9
//   route reaches for this first, and most (checkout, portal) never need
//   anything else.
//
...
//   This is the ONLY place in the M9 codebase that touches the
//   service-role key — checkout and portal session creation both get by
//   on the RLS-scoped client alone (see their route files for how).
