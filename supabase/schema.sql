...
-- ============================================================
-- Milestone 26: Tenant Connect + Maintenance Coordination M1.1 —
-- canonical maintenance case + safe production integration
-- (mirrors supabase/milestone-26-canonical-maintenance-case.sql
-- exactly, appended here for a single fresh-project run, matching
-- every prior milestone's convention in this file). See that file's
-- own header for the full canonical-architecture decision, and
-- docs/tenant-connect-maintenance-m1-foundation.md's M1.1 addendum
-- for the completion report this migration was written for.
-- ============================================================
