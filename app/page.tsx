    ...
    return (
      <main className="authShell">
        <section className="authCard setupCard">
          <p className="eyebrow">PROPPREPPED MILESTONE 8</p>
          <h1>Connect Supabase</h1>
          <p>PropPrepped is ready for persistent accounts, properties and private uploads. Add your project values to <code>.env.local</code>, then run the included <code>supabase/schema.sql</code> for a fresh project, or the <code>supabase/milestone-5-property-records.sql</code>, <code>supabase/milestone-6-property-network.sql</code>, <code>supabase/milestone-7-investment-tools.sql</code> and <code>supabase/milestone-8-document-intelligence.sql</code> upgrade files if you already have an earlier milestone installed. AI document analysis also needs a server-side <code>ANTHROPIC_API_KEY</code> — see <code>.env.example</code>.</p>
